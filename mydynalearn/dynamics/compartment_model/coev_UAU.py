...
class CoevUAU(CompartmentModel):
    ...
    def _dynamic_for_node(self, true_tp):
        ...
        true_tp[A1U_index, self.STATES_MAP["A_1U"]] = ((1 - self.MU_A1) * q_PRIME_A2)[A1U_index]
        true_tp[A1U_index, self.STATES_MAP["UA_2"]] = (self.MU_A1 * (1 - q_PRIME_A2))[A1U_index]
        true_tp[A1U_index, self.STATES_MAP["A_1A_2"]] = ((1 - self.MU_A1) * (1 - q_PRIME_A2))[
            A1U_index]
        # UA2实际迁移概率
        true_tp[UA2_index, self.STATES_MAP["UU"]] = (q_PRIME_A1 * self.MU_A2)[UA2_index]
        true_tp[UA2_index, self.STATES_MAP["A_1U"]] = ((1 - q_PRIME_A1) * self.MU_A2)[UA2_index]
        true_tp[UA2_index, self.STATES_MAP["UA_2"]] = (q_PRIME_A1 * (1 - self.MU_A2))[UA2_index]
        true_tp[UA2_index, self.STATES_MAP["A_1A_2"]] = ((1 - q_PRIME_A1) * (1 - self.MU_A2))[
            UA2_index]
        # UA2实际迁移概率
